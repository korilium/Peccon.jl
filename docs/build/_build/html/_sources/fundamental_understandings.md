...
```{tab-item} Answer 
First, set the monthly interest rate to the yearly interest rate. This is done by multiplying 1.02 12x times 

$$ 1.02^{12} \approx 1.27 $$ 

Know we know that the monthly interest rate is actually 2.7x times larger then the 10% interest rate. Option two becomes more attractive, but we still have to account for the initial capital: 
